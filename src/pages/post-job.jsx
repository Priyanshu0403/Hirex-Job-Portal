...
const schema = z.object({
  ...
  location: z.string().min(1, { message: "Select a Loaction" }),
...
const PostJob = () => {
  ...
  return (
    <div>
      <h1 className="gradient-title font-extrabold text-5xl sm:text-7xl text-center pb-8 sm:py-10">
        Post a Job
      </h1>
      ...
      <div className="flex gap-4 items-center">
        ...
        <Button type="submit" variant="blue" size="lg" className="mt-2" width="full">
          Submit
        </Button>
      </form>
    </div>
